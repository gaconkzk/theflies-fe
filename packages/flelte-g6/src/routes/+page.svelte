<script lang="ts">
  ...
  function scaleNodesPoints(nodes: NodeConfig[], edges: EdgeConfig[], graphSize: number[]) {
    ...
    edges.forEach(function (edge) {
      const controlPoints = edge.controlPoints as IPoint[]
  ...
  onMount(() => {
    fetch('https://gw.alipayobjects.com/os/basement_prod/8c2353b0-99a9-4a93-a5e1-3e7df1eac64f.json')
      ...
      .then((data: GraphData) => {
        ...
        const edges = data.edges as EdgeConfig[]
